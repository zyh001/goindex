...
document.write('<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/aplayer@1.10.1/dist/APlayer.min.css">')
document.write('<script src="https://cdn.jsdelivr.net/npm/aplayer@1.10.1/dist/APlayer.min.js"></script>')
// markdown支持
...
function copyToClip(content, message) {
    ...
    if (message == null) {
		try {
			document.getElementById("cp1").innerHTML="复制成功";
		}
		catch(err){
			document.getElementById("cp2").innerHTML="复制成功";
		}
		//alert('复制成功');
    } else{
        alert(message);
...
<div class="mdui-textfield">
	...
	<button id="cp1" class="mdui-btn mdui-ripple" onclick="copyToClip('${href}')"> 复制 </button>
</div>
...
<div class="mdui-container-fluid">
	...
	<div class="mdui-textfield">
	  ...
	  <button id="cp1" class="mdui-btn mdui-ripple" onclick="copyToClip('${url}')"> 复制 </button>
	</div>
	<div class="mdui-textfield">
	  <label class="mdui-textfield-label">HTML 引用地址</label>
	  <textarea class="mdui-textfield-input"><video><source src="${url}" type="video/mp4"></video></textarea>
	  <button id="cp2" class="mdui-btn mdui-ripple" onclick="copyToClip("<video><source src='${url}' type="video/mp4"></video>")"> 复制 </button>
	</div>
</div>
...
<div class="mdui-container-fluid">
	...
	<div class="mdui-textfield">
	  <label class="mdui-textfield-label">下载地址</label>
	  <input id="text" class="mdui-textfield-input" type="text" value="${url}"/>
	  <button id="cp1" class="mdui-btn mdui-ripple" onclick="copyToClip('${url}')"> 复制 </button>
	</div>
	<div class="mdui-textfield">
	  <label class="mdui-textfield-label">HTML 引用地址</label>
	  <textarea class="mdui-textfield-input"><audio><source src="${url}"></audio></textarea>
	  <button id="cp2" class="mdui-btn mdui-ripple" onclick="copyToClip("<audio><source src='${url}'></audio>")"> 复制 </button>
	</div>
</div>
<a href="${url}" class="mdui-fab mdui-fab-fixed mdui-ripple mdui-color-theme-accent"><i class="mdui-icon material-icons">file_download</i></a>
	`;
...
<div class="mdui-container-fluid">
	...
	<div class="mdui-textfield">
	  ...
	  <button id="cp1" class="mdui-btn mdui-ripple" onclick="copyToClip("<img src='${url}' />")"> 复制 </button>
	</div>
        <div class="mdui-textfield">
